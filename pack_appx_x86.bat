...
"C:\Program Files (x86)\Windows Kits\10\bin\10.0.16299.0\x86\makeappx.exe" pack /d ..\battlerobot-qt-uwp_release\release /p release_x86.appx /o
"C:\Program Files (x86)\Windows Kits\10\bin\10.0.16299.0\x86\SignTool" sign /f romashka.pfx /p Aa123456 /fd sha256 release_x86.appx
